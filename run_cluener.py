...
## Required parameters
flags.DEFINE_string(
    "data_dir", "CLUENER_DIR/",
    "The input data dir. Should contain the .tsv files (or other data files) "
    "for the task.")

flags.DEFINE_string(
    "albert_config_file", "ALBERT_BASE_ZH_DIR/albert_base/albert_config.json",
    "The config json file corresponding to the pre-trained ALBERT model. "
    "This specifies the model architecture.")

flags.DEFINE_string("task_name", "cluener", "The name of the task to train.")

flags.DEFINE_string(
    "vocab_file", "ALBERT_BASE_ZH_DIR/albert_base/vocab_chinese.txt",
...
flags.DEFINE_string(
    "output_dir", "outputs/cluener/",
    "The output directory where the model checkpoints will be written.")

flags.DEFINE_string("cached_dir", "outputs/cluener/",
...
flags.DEFINE_string(
    "init_checkpoint", "ALBERT_BASE_ZH_DIR/albert_base/model.ckpt-best",
...
flags.DEFINE_integer("train_step", 3,
...
def main(_):
  ...
  processors = {
      "cluener": ner_utils.CluenerProcessor,
  }
  ...
  if FLAGS.do_eval:
    ...
    if FLAGS.use_tpu:
      ...
      while len(eval_examples) % FLAGS.eval_batch_size != 0:
        eval_examples.append(ner_utils.PaddingInputExample())
  ...
  if FLAGS.do_predict:
    ...
    if FLAGS.use_tpu:
      ...
      while len(predict_examples) % FLAGS.predict_batch_size != 0:
        predict_examples.append(ner_utils.PaddingInputExample())
